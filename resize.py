...
def resize_and_optimize_gif(input_path, output_path, target_width=80, target_height=80, background_color=(0, 0, 0)):
...
# Example usage
input_gif_path = './keys/s.gif'
output_gif_path = './keys/output.gif'
